...
//Css
import companyscss from '../css/companys.css'; // Está sendo usado sim!
...
export default function Companys() {
    return (
        <section id="companys" className="about max-width" data-anime="left">
                ...
                <div className="company-logos">
                    <a href="https://www.thomsonreuters.com" rel="noopener noreferrer" target="_blank">
                        <div className="image-container">
                            <Image src={thomsonLogo} alt="Thomson Reuters Logo" width={400} />
                        </div>
                    </a>
                    ...
                    <a href="https://www.nissan.com.br/" rel="noopener noreferrer" target="_blank">
                        <div className="image-container">
                            <Image src={nissanLogo} alt="Nissan Logo" width={150} />
                        </div>
                    </a>
